	<header class="main-header">
						...
						<div class="search-bx mx-5">
							<form>
								<div class="input-group">
								  <input type="search" class="form-control" placeholder="Search Influencer" aria-label="Search" aria-describedby="button-addon2">
		  ...
		  <div class="navbar-custom-menu r-side">
			<ul class="nav navbar-nav">
				<li class="btn-group nav-item">
					<a href="../ajax/brand/auth/logout.php" id="logout" class="waves-effect waves-light nav-link bg-primary btn-primary w-auto fs-14">
						Log out
					</a>
				</li>
			</ul>
  	...
  	<nav class="main-nav" role="navigation">
		...
		<li><a href="index.php"><i class="icon-Layout-4-blocks"><span class="path1"></span><span class="path2"></span></i>Dashboard</a></li>
		<!-- <li><a href="create_campaign.php"><i class="icon-Address-card"></i>Create Campaign</a> -->
		</li> 
		<li><a href="search_influencer.php"><i class="icon-User"><span class="path1"></span><span class="path2"></span></i>Search Influencer</a>
			<!-- <ul> 
		...
		<li><a href="campaign_list.php"><i class="icon-Box2"><span class="path1"></span><span class="path2"></span></i>Campaigns</a></li>
		<li><a href="account.php"><i class="icon-Chat2"></i>Account</a></li>
