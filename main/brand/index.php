		...
		<section class="content">
			...
			<div class="col-xl-4 col-12">
			  <div class="info-box bg-success">
				<span class="info-box-icon push-bottom rounded-circle"><span class="icon-"><span class="path1"></span><span class="path2"></span></span></span>
			  ...
			  <!-- /.info-box -->
				...
				<div class="col-xl-12 col-12">
					<div class="box">
						<div class="box-header with-border">
						  <h3 class="box-title">Influencer details</h3>
						</div>
						<!-- /.box-header -->
						<div class="box-body">
				...
				<div class="col-xl-7 col-12">
							...
							<div class="table-responsive">
							  	<table class="table table-hover">
									<tbody>
										...
										<tr>
										  <td><img src="../../images/avatar/avatar-1.png" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="../../images/avatar/avatar-2.png" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="../../images/avatar/avatar-3.png" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="../../images/avatar/avatar-4.png" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="../../images/avatar/avatar-5.png" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="../../images/avatar/avatar-6.png" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="../../images/avatar/avatar-7.png" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
					...
					.owl-carousel .item .card {
						width: 400px; /* Set the width to the desired size */
						margin: 0 auto;
					}
					...
					.owl-carousel .item .card img {
						...
						width: 100%; /* Allow the images to fill the available space */
					}
					</style>

					<div class="box">
						<div class="box-header with-border">
							<h4 class="box-title">Today Views</h4>
						</div>
						<div class="box-body">
				...
				<div class="col-xl-5 col-12">
					<div class="box">
						<div class="box-body analytics-info">
							<!-- <h4 class="box-title">Age Split</h4> -->
				...
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Assigned Campaign</h3>
					</div>
					<div class="box-body">
...
<script>
	...
	function fetchDataCard() {
		...
		$.ajax({
			url: '../ajax/brand/camp_list_using_id.php',
			type: 'post',
			processData: false,
			contentType: false,
			data: fd,
			...
			success:function(response) {
				...
				var owlCarousel = $('.owl-carousel2');
            
            // Clear existing items in the carousel
            owlCarousel.trigger('destroy.owl.carousel');
            owlCarousel.find('.owl-stage-outer').children().unwrap();

            // Loop through the fetched data and create elements for the carousel
            data.forEach(function (value) {
                var item = $('<div class="item"></div>');
                var card = $('<div class="card"></div>');
                var cardBody = $('<div class="card-body"></div>');
                var row = $('<div class="row"></div>');
                var colImg = $('<div class="col-md-4 col-sm-4 text-center"></div>');
                var anchor = $('<a href="professors.html"><img src="../../images/avatar/2.jpg" alt="user" class="img-circle img-responsive" style="max-height: 210px;"></a>');
                var colText = $('<div class="col-md-8"></div>');
                var title = $('<h5 class="card-title mb-2">' + value.camp_name + '</h5>');
                var startDate = $('<p>' + value.start_dateTime + '</p>');
                var endDate = $('<p>' + value.end_dateTime + '</p>');
                var viewButton = $('<button class="btn btn-primary btn-sm mt-3">View</button>');

                // Append elements to build the structure
                colImg.append(anchor);
                colText.append(title).append(startDate).append(endDate);
                row.append(colImg).append(colText).append(viewButton);
                cardBody.append(row);
                card.append(cardBody);
                item.append(card);

                // Append the constructed item to the Owl Carousel
