<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $result = mysqli_query($conn, "INSERT INTO brand_user_data (`brand_name`, `contact_name`, `email`, `whatsapp_number`, `website`, `instagram_url`, `password`, `status`, `dateTime`) 
                    VALUES ('$b_name', '$c_name', '$email', '$w_num', '$website', '$i_url', '$enc_pass', 'Active', '$dateTime') ");
