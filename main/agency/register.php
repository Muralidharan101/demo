								...
								<!-- <form action="https://crm-admin-dashboard-template.multipurposethemes.com/university/horizontal/main/index.html" method="post"> -->
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="text" id="b_name" class="form-control ps-15 bg-transparent" placeholder="Agency Name*">
										</div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
		...
		$(document).ready(function(){
			$('#submit').click(function() {
				...
				if(a_name == '') {
					...
					$.ajax({
						url: '../ajax/agency/auth/reg_auth.php',
						type: 'post',
						processData: false,
						contentType: false,
						data: fd,
