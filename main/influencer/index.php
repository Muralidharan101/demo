...
<head>
    ...
    <title>Insta | Influencer Dashboard</title>
					...
					<div class="box">
						<div class="box-body">
							<div class="d-flex justify-content-between">
								<div>
									<h4 class="text-fade">Page Views</h4>
									<h4 class="fw-600">1,542</h4>
									<!-- <p class="mb-0"><span class="text-success">12%</span> Increase</p> -->
								</div>
								<div>
									<img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-24.svg" class="w-100" alt="" />
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-3 col-md-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex justify-content-between">
								<div>
									<h4 class="text-fade">Followers</h4>
									<h4 class="fw-600">742</h4>
									<!-- <p class="mb-0"><span class="text-success">09%</span> Increase</p> -->
								</div>
								<div>
									<img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-25.svg" class="w-100" alt="" />
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-3 col-md-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex justify-content-between">
								<div>
									<h4 class="text-fade">Today Likes</h4>
									<h4 class="fw-600">550</h4>
				...
				<div class="col-xl-3 col-md-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex justify-content-between">
								<div>
									<h4 class="text-fade">Following</h4>
								...
								<div>
									...
									<!-- <img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-27.svg" class="w-100" alt="" /> -->
								</div>
							</div>
						</div>
					</div>
...
<!-- ./wrapper -->
    ...
    var fd = new FormData();
    fd.append('inf_id', inf_id);

    $.ajax({
        url: '../ajax/influencer/inf_asnd_camp_list.php',
        type: 'post',
        processData: false,
        contentType: false,
        data: fd,
