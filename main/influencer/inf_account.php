<?php
	require_once '../ajax/influencer/auth/session.php';
?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="col-lg-4 col-md-12">
					<div class="box profile-header">
						<div class="box-body text-center">
							...
							<div>
								<h3 class="mb-0" id="inf_name">Influencer Name</h3>
						...
						<div class="tab-content">
							<div class="tab-pane py-30 active show" id="about">
								<ul class="list-unstyled">
									<li><p><strong>Brand Name: </strong> <span id="inf_name2"> b Name 2</span></p></li>
									<!-- <li><p><strong>Contact Name: </strong> <span id="contact_name2"> C_name</span> </p></li> -->
									<li><p><strong>Official Email: </strong><span id="email">Email</span></p></li>
									<li><p><strong>Whatsapp Number: </strong><span id="wt_num"> wt num</span> </p></li>
									<li><p><strong>Website: </strong><span id="insta_un">insta User name</span> </p></li>
									<li><p><strong>Youtube: </strong><span id="youtube"></span>youtube </p></li>
...
<!-- ./wrapper -->
	...
	<script>
		function fetchdata() {
			var inf_id = <?php echo $inf_id; ?>;
			var fd = new FormData();

			fd.append('id', inf_id);
			$.ajax({
				url: '../ajax/influencer/account/inf_account_list.php',
				type: 'post',
				contentType: false,
				processData: false,
				data: fd,
				...
				success:function(response) {
					...
					document.getElementById('inf_name').textContent = data[0].name;
					document.getElementById('inf_name2').textContent = data[0].name;
					document.getElementById('email').textContent = data[0].email;
					document.getElementById('wt_num').textContent = data[0].w_num;
					document.getElementById('insta_un').textContent = data[0].insta_un;
					document.getElementById('youtube').textContent = data[0].youtube;
				}
			})
		} fetchdata();
	</script>
