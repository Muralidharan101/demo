...
<head>
  <meta charset="utf-8">
    ...
    <title>Insta | Influencer Reg</title>
								...
								<!-- <form action="https://crm-admin-dashboard-template.multipurposethemes.com/university/horizontal/main/index.html" method="post"> -->
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="text" id="name" class="form-control ps-15 bg-transparent" placeholder="Name*">
										</div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="material-icons">email</i></span>
											<input type="email" id="email" class="form-control ps-15 bg-transparent" placeholder="Email*">
										</div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="text" id="i_url" class="form-control ps-15 bg-transparent" placeholder="Instagram Username*">
										</div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="ti-youtube"></i></span>
											<input type="text" id="youtube" class="form-control ps-15 bg-transparent" placeholder="Youtube">
										</div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
		...
		$(document).ready(function(){
			$('#submit').click(function() {
				...
				if(name == '') {
					...
					fd.append('yt', youtube);
					fd.append('pass', pass);

					$.ajax({
						url: '../ajax/influencer/auth/reg_auth.php',
						type: 'post',
						processData: false,
						contentType: false,
						data: fd,
