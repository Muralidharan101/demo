<header class="main-header">
		...
		<nav class="navbar navbar-static-top">
		  ...
		  <div class="navbar-custom-menu r-side">
			...
			<li class="btn-group nav-item">
				<a href="../ajax/influencer/auth/logout.php" id="logout" class="waves-effect waves-light nav-link bg-primary btn-primary w-auto fs-14">
					Log out
			    </a>
			</li>
	  ...
	  <ul id="main-menu" class="sm sm-blue"> 
		...
		<li><a href="javascript:void(0)"><i class="icon-Address-card"></i>Connect with instagram</a>
		</li> 
		<li><a href="assigned_campaigns.php"><i class="icon-Box2"><span class="path1"></span><span class="path2"></span></i>Assigned Campaigns</a></li>
		<li><a href="view_campaigns.php"><i class="icon-Chat2"></i>View Campaigns</a></li>
		
		<li><a href="inf_account.php"><i class="icon-Chat2"></i>Account</a></li>
